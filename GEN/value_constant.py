...
KEY_D_BOOKING_REQUEST_CONFIRMATOION = "BOOKING_REQUEST_CONFIRMATION"
KEY_D_BRANCH_OPERATIONAL_SELECTE_TIME = "BRANCH_OPERATIONAL_SELECTE_TIME"
KEY_D_SELECTE_BOOKING_TIMING = "SELECTED_BOOKING_TIMING"
...
KEY_D_CAN_ACCEPT_REQUEST = "CAN_ACCEPT_REQUEST "
KEY_D_CAN_COMPLETE_REQUEST = "CAN_COMPLETE_REQUEST "
KEY_D_CAN_CHECKIN = "CAN_CHECKIN"
...
KEY_D_NOT_REACHABLE = "NOT REACHABLE"
...
valueset = {
    ...
    KEY_D_BOOKING_REQUEST_CONFIRMATOION: {KEY_LANGUAGE_EN: "Booking Request Successful.Please wait for confirmation", KEY_LANGUAGE_TA: "முன்பதிவு கோரிக்கை வெற்றிகரமாக உள்ளது. உறுதிப்படுத்த காத்திருக்கவும்"},
    KEY_D_BRANCH_OPERATIONAL_SELECTE_TIME: {KEY_LANGUAGE_EN: "Branch not operational at selected time. Please try choosing some other time.",KEY_LANGUAGE_TA: "தேர்ந்தெடுக்கப்பட்ட நேரத்தில் கிளை செயல்படாது. வேறு சில நேரங்களைத் தேர்ந்தெடுக்க முயற்சிக்கவும்."},
    KEY_D_SELECTE_BOOKING_TIMING:{KEY_LANGUAGE_EN:"Selected time is booked. Please try choosing some other time.", KEY_LANGUAGE_TA:"இந்த நேரம் ஏற்கனவே முன்பதிவு செய்யப்பட்டுள்ளது, எனவே மற்றொரு நேரத்தைத் தேர்வுசெய்க"},
    ...
    KEY_D_NEW_BOOKING_REQUEST_VIEW_DETAILS: {KEY_LANGUAGE_EN: "There is a new booking request.Tap to view details", KEY_LANGUAGE_TA: "புதிய முன்பதிவு கோரிக்கை உள்ளது. விவரங்களைக் காண தட்டவும்"},
    ...
    KEY_D_CAN_ACCEPT_REQUEST: {KEY_LANGUAGE_EN: "Can Accept Request", KEY_LANGUAGE_TA: "கோரிக்கையை ஏற்க முடியும்"},
    KEY_D_CAN_COMPLETE_REQUEST: {KEY_LANGUAGE_EN: "Can Complete Request", KEY_LANGUAGE_TA: "கோரிக்கையை முடிக்க முடியும்"},
    KEY_D_CAN_CHECKIN: {KEY_LANGUAGE_EN:"Can Checkin",KEY_LANGUAGE_TA: "சரிபார்க்க முடியும்"},
